...
!other marginal dist
IF ((iteratingtransition==.false.) .and. (calibrating==.false.) .and. (exploring==.false.)) THEN
...
IF ((iteratingtransition==.false.) .and. (calibrating==.false. .or. MatchMedianLiq==1) .and. (exploring==.false. .or. MatchMedianLiq==1)  .and. (ngpy>1 .or. deathrate>0.0)) THEN
	DO ip = 1,11
...
IF ((iteratingtransition==.false.) .and. (calibrating==.false. .or. MatchMedianIll==1 .or. MatchP75Ill==1) .and. (exploring==.false. .or. MatchMedianIll==1 .or. MatchP75Ill==1)  .and. (ngpy>1 .or. deathrate>0.0)) THEN
	DO ip = 1,11
...
IF ((iteratingtransition==.false.) .and. (calibrating==.false.) .and. (exploring==.false.) .and. (ngpy>1 .or. deathrate>0.0)) THEN
	DO ip = 1,11
