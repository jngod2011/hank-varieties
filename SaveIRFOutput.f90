...
IF(SolveFlexPriceTransition==1) THEN
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'wage_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%wage_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'wage_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%wage_N)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'K_totoutput_ratio.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%K_totoutput_ratio)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'price_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%price_W)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'tfp_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%tfp_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'tfp_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%tfp_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'capital_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%capital_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'capital_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%capital_N)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'bond.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%bond)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'labor_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%labor_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'labor_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%labor_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'totoutput.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%totoutput)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'varieties.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%varieties)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'netprofit_R.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%netprofit_R)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'grossprofit_R.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%grossprofit_R)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'netprofit_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%netprofit_W)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'grossprofit_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%grossprofit_W)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'dividend_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%dividend_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'dividend_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%dividend_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'equity_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%equity_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'equity_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%equity_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'assetdrop_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%assetdrop_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'assetdrop_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmFLEX%assetdrop_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'Elabor_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsFLEX%Elabor_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'Elabor_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsFLEX%Elabor_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'Ehours_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsFLEX%Ehours_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "FLEX/" // 'Ehours_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsFLEX%Ehours_N)
...
IF(SolveStickyPriceTransition==1) THEN
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'wage_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%wage_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'wage_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%wage_N)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'K_totoutput_ratio.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%K_totoutput_ratio)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'price_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%price_W)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'tfp_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%tfp_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'tfp_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%tfp_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'capital_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%capital_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'capital_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%capital_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'labor_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%labor_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'labor_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%labor_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'totoutput.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%totoutput)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'varieties.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%varieties)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'netprofit_R.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%netprofit_R)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'grossprofit_R.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%grossprofit_R)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'netprofit_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%netprofit_W)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'grossprofit_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%grossprofit_W)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'dividend_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%dividend_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'dividend_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%dividend_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'equity_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%equity_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'equity_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%equity_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'assetdrop_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%assetdrop_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'assetdrop_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmSTICKY%assetdrop_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'Elabor_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsSTICKY%Elabor_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'Elabor_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsSTICKY%Elabor_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'Ehours_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsSTICKY%Ehours_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "STICKY/" // 'Ehours_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsSTICKY%Ehours_N)
...
IF(SolveZLBTransition==1) THEN
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'wage_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%wage_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'wage_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%wage_N)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'K_totoutput_ratio.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%K_totoutput_ratio)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'price_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%price_W)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'tfp_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%tfp_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'tfp_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%tfp_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'capital_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%capital_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'capital_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%capital_N)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'bond.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%bond)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'labor_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%labor_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'labor_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%labor_N)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'output.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%output)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'totoutput.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%totoutput)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'varieties.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%varieties)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'netprofit_R.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%netprofit_R)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'grossprofit_R.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%grossprofit_R)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'netprofit_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%netprofit_W)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'grossprofit_W.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%grossprofit_W)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'profit.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%profit)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'dividend_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%dividend_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'dividend_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%dividend_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'equity_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%equity_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'equity_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%equity_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'assetdrop_A.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%assetdrop_A)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'assetdrop_B.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%equmZLB%assetdrop_B)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'Elabor_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsZLB%Elabor_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'Elabor_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsZLB%Elabor_N)
	...
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'Ehours_Y.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsZLB%Ehours_Y)
	OPEN(3, FILE = trim(OutputDirIRF) // "ZLB/" // 'Ehours_N.txt', STATUS = 'replace'); CALL WriteMatrixExpon(3,Ttransition,1,irfsave%statsZLB%Ehours_N)
